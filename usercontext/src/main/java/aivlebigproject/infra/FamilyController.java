...
public class FamilyController {
  ...
  public ResponseEntity<FamilyLoginResponseDto> login(@RequestBody Family loginInfo) {
    Optional<Family> familyOptional =
        familyRepository.findByLoginIdAndLoginPassword(
  ...
  public ResponseEntity<String> findLoginId(@RequestParam String name, @RequestParam String email) {
    ...
    @GetMapping("/memorial")
    public ResponseEntity<List<Family>> getFamiliesByMemorialId(@RequestParam UUID memorialId) {
