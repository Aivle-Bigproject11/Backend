...
import aivlebigprojectminseo.domain.VideoImage;
...
public class ImageUploadService {
    ...
    public List<VideoImage> uploadVideoImages(Video video, List<MultipartFile> images) {
        logger.info("비디오 이미지 업로드 시작: videoId={}, 이미지 개수={}", video.getId(), images.size());
        ...
        logger.info("비디오 이미지 업로드 완료: videoId={}", video.getId());
