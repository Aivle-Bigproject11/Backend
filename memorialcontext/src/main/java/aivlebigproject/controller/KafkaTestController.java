...
public class KafkaTestController {
    ...
    public String sendEvent() {
        ...
        event1.setCustomerName("김철수");
        event1.setDeceasedName("김철수");
        event1.setDeceasedAge(75);
        event1.setDeceasedBirthOfDate(LocalDate.of(1949, 1, 1));
        event1.setDeceasedDate(LocalDate.of(2024, 7, 25));
        ...
        event2.setCustomerName("이영희");
        event2.setDeceasedName("이영희");
        event2.setDeceasedAge(82);
        event2.setDeceasedBirthOfDate(LocalDate.of(1942, 3, 15));
        event2.setDeceasedDate(LocalDate.of(2024, 6, 30));
        ...
        event3.setCustomerName("박철수");
        event3.setDeceasedName("박철수");
        event3.setDeceasedAge(68);
        event3.setDeceasedBirthOfDate(LocalDate.of(1956, 9, 20));
        event3.setDeceasedDate(LocalDate.of(2024, 8, 1));
        ...
        event4.setCustomerName("최지은");
        event4.setDeceasedName("최지은");
        event4.setDeceasedAge(90);
        event4.setDeceasedBirthOfDate(LocalDate.of(1934, 11, 2));
        event4.setDeceasedDate(LocalDate.of(2024, 7, 10));
        ...
        event5.setCustomerName("정수현");
        event5.setDeceasedName("정수현");
        event5.setDeceasedAge(60);
        event5.setDeceasedBirthOfDate(LocalDate.of(1964, 5, 27));
        event5.setDeceasedDate(LocalDate.of(2024, 6, 15));
