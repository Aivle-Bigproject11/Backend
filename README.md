...
```
 ...
 http :8088/families id="id"loginId="loginId"loginPassword="loginPassword"name="name"email="email"phone="phone"status="status"memorialId="memorialId"createdAt="createdAt"updatedAt="updatedAt"
```
- memorialcontext
```
